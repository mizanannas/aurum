...
export const mockTrendForecast: TrendForecastItem[] = [
  { period: 'Next 24 Hours', direction: 'BULLISH', confidence: 92, conviction: 'High Conviction' },
  { period: 'Next 3 Days', direction: 'BULLISH', confidence: 78, conviction: 'Mid Conviction' },
  { period: 'Next 7 Days', direction: 'SIDEWAYS', confidence: 61, conviction: 'Low Conviction' },
];

export const mockDynamicRange: DynamicRange = {
  highest: 3385.00,
  lowest: 3260.00,
};

export const mockTradeLogs: TradeLog[] = [
  { timestamp: '[10:32:11]', category: 'System', message: 'Connected to broker', type: 'success' },
  { timestamp: '[10:33:02]', category: 'AI Engine', message: 'Signal: STRONG BUY (89%)', type: 'info' },
  { timestamp: '[10:33:45]', category: 'Price Feed', message: 'XAU/USD: $3,327.50 (+0.37%)', type: 'info' },
  { timestamp: '[10:34:10]', category: 'User', message: 'Lot 0.10 | BUY @ $3,327.45', type: 'info' },
  { timestamp: '[10:34:11]', category: 'System', message: 'Log position executed successfully', type: 'warning' },
];